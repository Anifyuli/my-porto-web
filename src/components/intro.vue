...
<template>
  <div class="grid place-content-center mb-10">
    <!-- Content start -->
    <div class="flex flex-row justify-evenly w-screen mt-5">
      <div class="grid h-fit basis-2/5 card w-screen mx-10 py-3 space-y-3 place-items-center">
